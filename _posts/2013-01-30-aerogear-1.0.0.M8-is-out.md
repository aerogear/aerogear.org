...
You can read more about the API [side-by-side usage comparison](/docs/specs/aerogear-client-paging-usage/), or look at the [specification](/docs/spec/aerogear-client-paging/) we've put together.
