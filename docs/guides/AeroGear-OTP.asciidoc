...
If you are an iOS developer, you can find the library already in the link:http://cocoapods.org/?q=aerogear-otp[coccoapods]. Further a demo application has been created that demos the library in action, so I suggest you have a look. You can find it link:https://github.com/aerogear/aerogear-otp-ios-demo/zipball/1.0.0[here].
