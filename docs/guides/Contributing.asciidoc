...
If you've got ideas for the project, or want to discuss ways to improve AeroGear join the https://lists.jboss.org/mailman/listinfo/aerogear-dev[aerogear-dev] mailing list, and let your ideas be heard. If you've already done that, or found an issue with our stuff check out the next section.
