...
* link:/docs/guides/aerogear-push-cordova-android/google-setup/[Setup for android]
* link:/docs/guides/aerogear-push-cordova-ios/app-id-ssl-certificate-apns/[Setup for ios]
