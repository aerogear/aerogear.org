...
The sender will use this to trigger a 'special internal' page within the plugin that will call your javascript callback and parse the user-data. Without the app will come to foreground without invoking the javascript callback like you are used on the other platforms.
