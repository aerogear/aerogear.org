...
<ul class="nav nav-tabs nav-snippets">
  <li class="active"><a href="#keycloak" class="btn btn-primary"><i class="fa fa-shield"></i> Keycloak</a></li>
  <li><a href="#facebook" class="btn btn-primary" title="Facebook"><i class="fa fa-facebook"></i> Facebook</a></li>
  <li><a href="#google" class="btn btn-primary" title="Google"><i class="fa fa-google"></i> Google</a></li>
</ul>
<script defer src="/js/code-snippets.js"></script>

<div id="keycloak" class="snippet-oauth2" style="display: none">
</br>
...
<div id="facebook" class="snippet-oauth2">
</br>
...
<div id="google" class="snippet-oauth2">
</br>
