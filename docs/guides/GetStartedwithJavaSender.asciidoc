...
[source,java]
----
    variants(Arrays.asList("c3f0a94f-48de-4b77-a08e-68114460857e" /* HR_Premium */, "444939cd-ae63-4ce1-96a4-de74b77e3737" /* HR_Free */));
----
...
[source,java]
----
    .deviceType(Arrays.asList("iPhone", "iPad_Mini"));
----
