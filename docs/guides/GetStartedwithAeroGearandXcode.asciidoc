...
TIP: As of version 1.0 of AeroGear, we are also offering an Xcode template for our users to get started with. Click link:../GetStartedwithAeroGearandXcodeTemplate/[here] for more information.
