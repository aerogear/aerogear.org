...
You can download the source code of this project from link:https://github.com/aerogear/aerogear-ios-cookbook/PipeDemo[github]. For more complete example applications that utilize different parts of the AeroGear library, have a look at our available cookbooks examples on link:https://github.com/aerogear/aerogear-ios-cookbook[github].
