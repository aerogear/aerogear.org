...
__Note:__ that since iOS8 _registerForRemoteNotificationTypes_ has been removed in favor of _registerUserNotificationSettings_. For remote push notification you will need the extra step to call _registerForRemoteNotifications_. If you want to offer support for both iOS7 and iOS8, follow this code snippet:
