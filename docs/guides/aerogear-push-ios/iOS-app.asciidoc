...
Afterwards, please clone this link:https://github.com/aerogear/aerogear-push-ios-demo[Sample Application]. It uses our _early_ SDK to register your _Variant Instance_ (the application on the device) with the iOS Variant you registered earlier!
