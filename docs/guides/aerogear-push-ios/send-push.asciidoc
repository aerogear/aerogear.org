...
When the application is inactive, and a _Push Notification_, containing the _alert_ key, is received by the device. An _Popup_ will show up, which displays the value of the _alert_ key:
