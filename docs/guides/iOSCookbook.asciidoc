...
Since 1.3.0 release of the library, we build on the security foundation provided by link:https://github.com/aerogear/aerogear-crypto-ios[aerogear-crypto-ios]
to offer encrypted variants of our existing in-memory and plist based data stores
 ...
 your data, you will be happy to know that you easily switch to an encrypted variant by simple changing the
