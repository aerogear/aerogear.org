...
** Conflict resolution handling link:https://issues.jboss.org/browse/AGIOS-266
** DiffMatchPatch conflict resolver link:https://issues.jboss.org/browse/AGIOS-267
...
** Provide Notification handler that is capable of delegeting to a configured Conflict Resolver link:https://issues.jboss.org/browse/AGIOS-268
...
** Partial Updates for iOS link:https://issues.jboss.org/browse/AGIOS-269
