...
image:http://launch-shifter.rhcloud.com/launch/light/LAUNCH ON.svg["Run me on Openshift",link="https://openshift.redhat.com/app/console/application_type/quickstart!31"]

Now, just fill in the form and click on +Create Application+! This creates an UnifiedPush Server instance with a configured _MySQL 5.5_ database. Click on +Continue to the application overview page+.
