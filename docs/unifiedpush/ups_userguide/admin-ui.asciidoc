...
NOTE: The import file must have the expected JSON structure as defined link:/docs/specs/aerogear-unifiedpush-rest-1.0.x/registry/device/importer/index.html[here].
