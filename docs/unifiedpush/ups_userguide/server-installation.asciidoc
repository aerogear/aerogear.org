...
NOTE: On JBoss EAP 6.3 you need to use the +h2-database-config.cli+ script instead.
...
NOTE: On JBoss EAP 6.3 you need to use the +mysql-database-config.cli+ script instead.
...
NOTE: On JBoss EAP 6.3 you need to use the +postgresql-database-config.cli+ script instead.
