...
Basically, browsers that support this feature, are able to remember the fact that a particular website requires HTTPS only, upon the next visit to the respective site the agent will remember about this option on HTTPS only. 
