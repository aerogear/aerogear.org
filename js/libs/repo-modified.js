                ...
                $.each(response.data.tree, function(i){
                    ...
                    $.each(arr, function(i){
                        ...
                        if(!exists){
                            ...
                            if(output !== first){
                                output.find('ul li.back').after($('<li class="dir"><i class="icon-folder-open"></i><a href="#" data-id="' + id + '">' + name +'</a></li>'));
                            } else {
                                output.find('ul li').first().after($('<li class="dir"><i class="icon-folder-open"></i><a href="#" data-id="' + id + '">' + name +'</a></li>'));    
                            }
                    ...
                    // Append file to DOM
                    output.find('ul').append($('<li class="file"><i class="icon-file"></i><a href="#" data-path="' + path + '" data-id="' + id + '">' + file +'</a></li>'));
